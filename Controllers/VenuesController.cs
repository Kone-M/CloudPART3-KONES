...
namespace VenueBookingSystem.Controllers
{
    public class VenuesController : Controller
    {
        ...
        // POST: Venues/Create with image upload and availability fields
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Create([Bind("VenueName,Location,Capacity,AvailabilityStatus,OperatingHours,LastMaintenanceDate,NextAvailableDate")] Venue venue, IFormFile? imageFile)
        {
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if (string.IsNullOrEmpty(venue.AvailabilityStatus))
                    {
        ...
        // POST: Venues/Edit with availability fields
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("VenueID,VenueName,Location,Capacity,IsActive,AvailabilityStatus,OperatingHours,LastMaintenanceDate,NextAvailableDate")] Venue venue, IFormFile? imageFile)
        {
            if (id != venue.VenueID)
            {
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    existingVenue.AvailabilityStatus = venue.AvailabilityStatus;
                    existingVenue.OperatingHours = venue.OperatingHours;
                    existingVenue.LastMaintenanceDate = venue.LastMaintenanceDate;
                    existingVenue.NextAvailableDate = venue.NextAvailableDate;
