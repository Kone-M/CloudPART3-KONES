...
namespace VenueBookingSystem.Controllers
{
    public class EventsController : Controller
    {
        ...
        {
            ViewBag.EventTypes = _context.EventTypes
        ...
        public async Task<IActionResult> Create([Bind("EventName,Description,EventDate,DurationHours,OrganizerName,EventTypeID")] Event @event)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EventID,EventName,Description,EventDate,DurationHours,OrganizerName,EventTypeID")] Event @event)
        {
            if (id != @event.EventID)
            {
                return NotFound();
